...
<body>
  ...
  <svg style="display: none;">
    <defs>
      ...
      <svg id="workout_icon" viewBox="0 0 64 64" preserveAspectRatio="xMinYMin meet">
    ...
    <div class="col-container">
        ...
        <li class="nav-item workouts<?php if ($page == "workouts") { echo " on"; } ?>"><a class="nav-link" href="workout_list.php">workouts</a></li>
